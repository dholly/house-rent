        ...
        */
        function cf7_popups_load_scripts() {
            ...
            $localize_options =  array(
                'msg1' => esc_html__('Что-то пошло не так','cf7-popups'),
                'msg2' => esc_html__('Пожалуйста проверьте введёные данные','cf7-popups'),
                'msg3' => esc_html__('Ошибка','cf7-popups'),
                'msg4' => esc_html__('Не удалось отправить Email из-за возможной угрозы спама','cf7-popups'),
                'msg5' => esc_html__('Не удалось отправить Email','cf7-popups'),
                'msg6' => esc_html__('Сообщение успешно отправлено','cf7-popups'),
                'msg7' => esc_html__('Благодарим за ваше сообщение','cf7-popups'),
                );
